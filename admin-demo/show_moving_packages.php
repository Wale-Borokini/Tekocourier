...
<head>
	<title>Show Moving Packages</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
								...
								<table id="example" class="display table-hover table-responsive-xl">
									<thead>
										<tr>
											...
											<th>Set To Pending</th>	
										</tr>
									</thead>
									<?php
									 global $ConnectingDB;
									 $sql ="SELECT * FROM pickup_schedule WHERE Delivery_Status='Moving' ORDER BY id desc";
									...
									<tbody>
										<tr>
											...
											<td> <a href="set_status_to_pending.php?id=<?php echo $id;?>" class="btn btn-warning">Set To Pending</a></td>
