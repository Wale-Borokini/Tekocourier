...
<head>
	<title>Delete Pending Packages</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<body>
								...
								<table id="example" class="display table-hover table-responsive-xl">
									...
									<tbody>
										<tr>
											...
											<td> <a href="delete_pending_users.php?id=<?php echo $id;?>" class="confirmDeleteButtonForPendPkg btn btn-danger">Delete</a>
										</tr>		
									</tbody>
									<?php } ?>
								</table>
	...
	<script type="text/javascript">
		$('.confirmDeleteButtonForPendPkg').on('click', function () {
        return confirm('Are You Sure You Want To Delete This booking Information?');
    })   
	</script>
</body>
